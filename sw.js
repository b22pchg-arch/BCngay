...
const APP_VERSION = "V150-PWA-1.0.0";
const CACHE_NAME = "scada-report-v150-pwa-1.0.0";
const CORE_ASSETS = [
  './',
  './index.html',
...
self.addEventListener('fetch', event => {
  ...
  if (pathname.endsWith('/index.html') || pathname.endsWith('/pwa-bootstrap.js') || pathname.endsWith('/version.json') || pathname.endsWith('/manifest.webmanifest')) {
